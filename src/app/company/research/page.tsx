    ...
    <div style={{ background: "#FFFFFF" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(120% 100% at 50% 0%,#13294a 0%,#0B1A2E 52%,#081320 100%)" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1080, margin: "0 auto", padding: "clamp(52px, 13vw, 86px) clamp(20px, 5vw, 32px) clamp(35px, 10vw, 64px)", textAlign: "center" }}>
          ...
          <h1 style={{ ...rise(".85s", "entry 0% cover 24%"), fontFamily: serif, fontWeight: 400, fontSize: "clamp(30px, 6.4vw, 54px)", lineHeight: 1.06, letterSpacing: "-0.02em", color: "#FFFFFF", margin: "0 0 22px" }}>Credibility is not claimed. It is <span style={{ fontStyle: "italic", color: "#16B9A6" }}>published</span>.</h1>
          ...
          <Link href="/company/research" className="nm-ghost-dark nm-research-feature" style={{ ...rise("1s", "entry 0% cover 30%"), textDecoration: "none", display: "grid", gridTemplateColumns: "1.1fr 0.9fr", border: "1px solid rgba(226,232,241,0.16)", borderRadius: 20, overflow: "hidden", background: "linear-gradient(160deg,rgba(13,28,48,0.6),rgba(8,18,30,0.85))", boxShadow: "0 30px 80px rgba(0,0,0,0.45)" }}>
            ...
            <div style={{ background: "#081320", position: "relative", overflow: "hidden", minHeight: 240, display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <svg viewBox="0 0 260 220" style={{ width: "78%", position: "relative" }}>
                ...
                <circle cx="130" cy="150" r="26" fill="none" stroke="#16B9A6" strokeWidth="1.2">
        ...
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
          <div className="nm-overview-grid" style={{ display: "grid", gridTemplateColumns: "0.36fr 0.64fr", gap: 56 }}>
            <div style={{ ...rise(".8s", "entry 0% cover 24%") }}>
              ...
              <div style={{ fontFamily: serif, fontSize: "clamp(20px, 3.4vw, 26px)", lineHeight: 1.22, color: "#0A1424", letterSpacing: "-0.01em" }}>A security firm earns trust in exactly one durable way.</div>
            </div>
            <div>
          ...
          <div className="nm-disc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
            {streams.map((s) => (
              <div key={s.name} className="nm-feature-card" style={{ ...rise(".8s", "entry 0% cover 30%"), background: "#FFFFFF", border: "1px solid #E2E8F1", borderRadius: 16, padding: "clamp(20px, 4vw, 32px)" }}>
                ...
                <h3 style={{ fontFamily: sans, fontWeight: 600, fontSize: "clamp(15.5px, 2.4vw, 18px)", color: "#0A1424", margin: "0 0 12px", letterSpacing: "-0.01em" }}>{s.name}</h3>
      ...
      {/* CTA */}
      <section style={{ background: "#0B1A2E", padding: "clamp(42px, 11vw, 84px) clamp(20px, 5vw, 32px)", position: "relative", overflow: "hidden" }}>
