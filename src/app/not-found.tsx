  ...
  return (
    <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(120% 100% at 50% 0%,#13294a 0%,#0B1A2E 52%,#081320 100%)", minHeight: "76vh", display: "flex", alignItems: "center" }}>
      ...
      <div style={{ position: "relative", maxWidth: 720, margin: "0 auto", padding: "clamp(48px, 11vw, 96px) clamp(20px, 5vw, 32px)", textAlign: "center" }}>
        ...
        <div style={{ fontFamily: mono, fontSize: 11.5, letterSpacing: "0.24em", color: "#16B9A6", marginBottom: 22 }}>404 · TRAIL LOST</div>
        <h1 style={{ fontFamily: serif, fontWeight: 400, fontSize: "clamp(30px, 6.4vw, 52px)", lineHeight: 1.06, letterSpacing: "-0.02em", color: "#FFFFFF", margin: "0 0 20px" }}>
          This path led <span style={{ fontStyle: "italic", color: "#16B9A6" }}>nowhere</span>.
        </h1>
        ...
        <div style={{ display: "flex", gap: 13, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/" className="nm-cta-primary" style={{ padding: "15px 28px", background: "linear-gradient(180deg,#42E6D2,#13B19E)", color: "#04231f", fontFamily: sans, fontSize: 15, fontWeight: 600, textDecoration: "none", borderRadius: 9, boxShadow: "0 8px 28px rgba(22,185,166,0.32)" }}>Back to home</Link>
