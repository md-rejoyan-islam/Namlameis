  ...
  return (
    <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(120% 100% at 50% 0%,#1E0B4E 0%,#120428 52%,#080214 100%)", minHeight: "76vh", display: "flex", alignItems: "center" }}>
      ...
      <div style={{ position: "relative", maxWidth: 720, margin: "0 auto", padding: "clamp(48px, 11vw, 96px) clamp(20px, 5vw, 32px)", textAlign: "center" }}>
        ...
        <div style={{ fontFamily: mono, fontSize: 11.5, letterSpacing: "0.24em", color: "#A5A2FF", marginBottom: 22 }}>404 · TRAIL LOST</div>
        <h1 style={{ fontFamily: serif, fontWeight: 400, fontSize: "clamp(30px, 6.4vw, 52px)", lineHeight: 1.06, letterSpacing: "-0.02em", color: "#FFFFFF", margin: "0 0 20px" }}>
          This path led <span style={{ fontStyle: "italic", color: "#B77BEE" }}>nowhere</span>.
        </h1>
        ...
        <div style={{ display: "flex", gap: 13, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/" className="nm-cta-primary" style={{ padding: "15px 28px", background: "var(--grad-cta)", color: "#FFFFFF", fontFamily: sans, fontSize: 15, fontWeight: 600, textDecoration: "none", borderRadius: 9, boxShadow: "0 8px 28px rgba(73,69,255,0.32)" }}>Back to home</Link>
          <Link href="/solutions" className="nm-ghost-dark" style={{ padding: "14px 26px", background: "rgba(247,249,252,0.05)", border: "1px solid rgba(200,200,220,0.2)", color: "#FFFFFF", fontFamily: sans, fontSize: 14.5, fontWeight: 500, textDecoration: "none", borderRadius: 9 }}>Explore solutions</Link>
        </div>
      </div>
    </section>
  );
