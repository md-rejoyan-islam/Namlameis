            ...
            <div className="nm-portal-body" style={{ background: "#FFFFFF", padding: 28, display: "grid", gridTemplateColumns: "1fr 240px", gap: 22 }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 26 }}>
                  <span style={{ width: 46, height: 46, borderRadius: 11, background: "rgba(22,185,166,0.12)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#16B9A6" strokeWidth="1.6"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3 9h18" /></svg>
                  </span>
                  <div>
                    <div style={{ fontFamily: sans, fontWeight: 700, fontSize: 19, color: "#0A1424" }}>Acme Financial</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>
                  <div style={{ border: "1px solid #E2E8F1", borderRadius: 10, padding: 16, textAlign: "center" }}><div style={{ fontSize: 15, color: "#0A1424", fontWeight: 600 }}>12 findings</div></div>
                  <div style={{ border: "1px solid #E2E8F1", borderRadius: 10, padding: 16, textAlign: "center" }}><div style={{ fontSize: 15, color: "#0A1424", fontWeight: 600 }}>4 critical</div></div>
                  <div style={{ border: "1px solid #E2E8F1", borderRadius: 10, padding: 16, textAlign: "center" }}><div style={{ fontSize: 13.5, color: "#0A1424", fontWeight: 600 }}>remediation tracked</div></div>
                </div>
              </div>
              <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F1", borderRadius: 12, padding: 18, display: "flex", flexDirection: "column", gap: 6 }}>
                {[["Scope", false], ["Findings", true], ["Remediation", false], ["Reports", false]].map(([label, active]) => (
                  <div key={label as string} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 4px" }}>
                    <span style={{ fontSize: 15, color: active ? "#16B9A6" : "#475569", fontWeight: active ? 600 : 400 }}>{label as string}</span>
                    <span style={{ width: 7, height: 7, borderRadius: "50%", background: active ? "#16B9A6" : "#cbd5e1" }} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="nm-portal-body" style={{ background: "#FFFFFF", padding: 30, display: "grid", gridTemplateColumns: "1fr 280px", gap: 30, alignItems: "center" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[["Critical", "30%", "#16B9A6", 4], ["High", "52%", "#16B9A6", 7], ["Medium", "78%", "#1FA98F", 11], ["Low", "44%", "#cbd5e1", 6]].map(([name, w, color, n]) => (
                    <div key={name as string} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      ...
                      <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <span style={{ fontWeight: 700, fontSize: 14, color: "#0A1424" }}>{n as number}</span>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      return (
        <div style={{ position: "relative", maxWidth: 920, margin: "0 auto", padding: "0 32px 70px" }}>
          <div className="nm-trust-grid" style={{ animation: "nm-rise 1s both", animationTimeline: "view()", animationRange: "entry 0% cover 26%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 } as CSSProperties}>
            {[
              { t: "Data Protection", d: "Encryption in transit & at rest", tint: "rgba(22,185,166,0.14)", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#16B9A6" strokeWidth="1.6"><rect x="4" y="10" width="16" height="11" rx="2" /><path d="M8 10V7a4 4 0 0 1 8 0v3" /></svg> },
              { t: "Access Control", d: "Least privilege, full audit", tint: "rgba(31,169,143,0.14)", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1FA98F" strokeWidth="1.6"><circle cx="12" cy="8" r="3.4" /><path d="M5.5 20a6.5 6.5 0 0 1 13 0" strokeLinecap="round" /></svg> },
              { t: "Compliance", d: "GDPR · Austrian DSG aligned", tint: "rgba(22,185,166,0.14)", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#16B9A6" strokeWidth="1.6"><path d="M12 3l7 3v5c0 4.4-3 7.6-7 9-4-1.4-7-4.6-7-9V6z" strokeLinejoin="round" /><path d="M9 12l2 2 4-4" strokeLinecap="round" /></svg> },
              { t: "Disclosure", d: "Responsible-disclosure channel", tint: "rgba(31,169,143,0.14)", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1FA98F" strokeWidth="1.6"><path d="M7 3h7l5 5v13H7z" strokeLinejoin="round" /><path d="M14 3v5h5M10 13h6M10 17h4" strokeLinecap="round" /></svg> },
            ].map((c) => (
              <div key={c.t} style={{ background: "rgba(247,249,252,0.04)", border: "1px solid rgba(226,232,241,0.14)", borderRadius: 16, padding: 26, display: "flex", alignItems: "flex-start", gap: 16, position: "relative" }}>
                ...
                <span style={{ position: "absolute", top: 20, right: 20, width: 9, height: 9, borderRadius: "50%", background: "#1FA98F", animation: "nm-breathe 3s ease-in-out infinite" }} />
              </div>
            ))}
          </div>
        </div>
      ...
      return (
        <div style={{ position: "relative", maxWidth: 980, margin: "0 auto", padding: "0 32px 70px" }}>
          <div className="nm-brief-grid" style={{ animation: "nm-rise 1s both", animationTimeline: "view()", animationRange: "entry 0% cover 26%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 } as CSSProperties}>
            <div style={{ background: "#0A1424", border: "1px solid rgba(22,185,166,0.3)", borderRadius: 16, padding: 34, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <span style={{ position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(22,185,166,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(22,185,166,0.06) 1px,transparent 1px)", backgroundSize: "28px 28px", animation: "nm-drift 24s linear infinite", opacity: 0.6 }} />
              <span style={{ position: "relative", fontFamily: mono, fontSize: 10, letterSpacing: "0.18em", color: "#16B9A6", marginBottom: 16 }}>FEATURED RESEARCH</span>
              ...
              <a href="/company/research" style={{ position: "relative", alignSelf: "flex-start", padding: "11px 26px", background: "linear-gradient(180deg,#42E6D2,#13B19E)", color: "#04231f", fontSize: 14, fontWeight: 600, textDecoration: "none", borderRadius: 30 }}>Read</a>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              {[["Compliance", "DORA in practice"], ["Research", "Adversarial testing"], ["Briefing", "AI threats this month"], ["Perspective", "Narrative as attack surface"]].map(([tag, title]) => (
                <a key={title as string} href="/company/research" style={{ textDecoration: "none", background: "rgba(247,249,252,0.04)", border: "1px solid rgba(226,232,241,0.12)", borderRadius: 13, padding: 18, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <span style={{ fontFamily: mono, fontSize: 9.5, letterSpacing: "0.06em", color: "#16B9A6", background: "rgba(22,185,166,0.12)", borderRadius: 5, padding: "3px 8px", alignSelf: "flex-start", marginBottom: 14 }}>{tag as string}</span>
                  <span style={{ fontSize: 14.5, fontWeight: 550, color: "#FFFFFF", lineHeight: 1.3, marginBottom: 12 }}>{title as string}</span>
                  <span style={{ fontFamily: mono, fontSize: 11, color: "#16B9A6" }}>Read →</span>
                </a>
              ))}
            </div>
          </div>
...
const svcLabel: CSSProperties = { fontFamily: mono, fontSize: 10, letterSpacing: "0.2em", color: "#16B9A6", marginBottom: 18 };
          ...
          <div style={svcWrap}>
            ...
            <svg viewBox="0 0 440 300" style={{ width: "100%", display: "block" }}>
              ...
              <g fontFamily={mono} fontSize="9.5">
                ...
                <rect x="320" y="140" width="110" height="28" rx="6" fill="none" stroke="#1FA98F" /><circle cx="336" cy="154" r="4" fill="#1FA98F" /><text x="348" y="157" fill="#FFFFFF">Internal</text>
      ...
      return (
        <figure style={svcFig}>
          <div style={svcWrap}>
            ...
            <svg viewBox="0 0 440 300" style={{ width: "100%", display: "block" }}>
              <g fontFamily={sans}>
                {[["User · Alice", "authorised", 30, "#1FA98F", false], ["User · Bob", "authorised", 92, "#1FA98F", false], ["Service acct", "authorised", 154, "#1FA98F", false], ["AI agent", "EXCESS ACCESS", 216, "#16B9A6", true]].map(([name, sub, y, c, warn]) => (
                  <g key={name as string} transform={`translate(8,${y})`}>
                    <rect width="34" height="34" rx="9" fill={(warn ? "rgba(22,185,166,0.18)" : "rgba(31,169,143,0.14)")} />
              ...
              <g fill="none">
                ...
                <path d="M150 233 L286 180" stroke="#16B9A6" strokeWidth="1.8" strokeDasharray="6 5" style={{ animation: "nm-flow 1.3s linear infinite" }} />
              </g>
              <path d="M280 175 l8 5 l-8 5" fill="none" stroke="#16B9A6" strokeWidth="1.6" />
            </svg>
          </div>
        </figure>
      );
          ...
          <div style={svcWrap}>
            ...
            <svg viewBox="0 0 440 290" style={{ width: "100%", display: "block" }}>
              ...
              <g fontFamily={sans} fontSize="12">
                <rect x="26" y="78" width="214" height="32" rx="7" fill="rgba(31,169,143,0.1)" stroke="#1FA98F" /><text x="42" y="98" fill="#FFFFFF">Sanctioned LLM</text><text x="224" y="99" textAnchor="end" fill="#1FA98F" fontSize="14">✓</text>
                <rect x="26" y="118" width="214" height="32" rx="7" fill="rgba(31,169,143,0.1)" stroke="#1FA98F" /><text x="42" y="138" fill="#FFFFFF">Copilot</text><text x="224" y="139" textAnchor="end" fill="#1FA98F" fontSize="14">✓</text>
                <rect x="26" y="158" width="214" height="32" rx="7" fill="rgba(22,185,166,0.1)" stroke="#16B9A6" /><text x="42" y="178" fill="#FFFFFF">Public ChatGPT</text><text x="224" y="179" textAnchor="end" fill="#16B9A6" fontSize="14" fontWeight="700">!</text>
                <rect x="26" y="198" width="214" height="32" rx="7" fill="rgba(22,185,166,0.1)" stroke="#16B9A6" /><text x="42" y="218" fill="#FFFFFF">Unknown tool</text><text x="224" y="219" textAnchor="end" fill="#16B9A6" fontSize="14" fontWeight="700">!</text>
              </g>
              <g fill="none" stroke="#16B9A6" strokeWidth="1.8" strokeDasharray="6 5">
          ...
          <div style={svcWrap}>
            ...
            <svg viewBox="0 0 440 280" style={{ width: "100%", display: "block" }}>
              ...
              <g fontFamily={sans} fontSize="12.5">
                <circle cx="312" cy="100" r="5" fill="#16B9A6" /><text x="326" y="105" fill="#FFFFFF">Real exfiltration</text>
                <circle cx="312" cy="143" r="5" fill="#16B9A6" /><text x="326" y="148" fill="#FFFFFF">Policy violation</text>
                <circle cx="312" cy="186" r="5" fill="#16B9A6" /><text x="326" y="191" fill="#FFFFFF">Unusual access</text>
              </g>
            </svg>
          </div>
        </figure>
          ...
          <div style={svcWrap}>
            ...
            <svg viewBox="0 0 360 300" style={{ width: "100%", display: "block" }}>
              ...
              <g style={{ transformOrigin: "180px 150px", animation: "nm-orbit 16s linear infinite" }}>
                <path d="M180 50 A100 100 0 0 1 280 150" fill="none" stroke="#16B9A6" strokeWidth="2.5" strokeLinecap="round" opacity="0.85" />
              </g>
              <g fontFamily={sans} fontSize="14" fontWeight="600">
                <g><circle cx="180" cy="50" r="34" fill="#0B1A2E" stroke="#16B9A6" strokeWidth="2" /><text x="180" y="55" textAnchor="middle" fill="#FFFFFF">Assess</text></g>
                <g><circle cx="280" cy="150" r="34" fill="#0B1A2E" stroke="#1FA98F" strokeWidth="2" /><text x="280" y="155" textAnchor="middle" fill="#FFFFFF">Reduce</text></g>
                <g><circle cx="180" cy="250" r="34" fill="#0B1A2E" stroke="#16B9A6" strokeWidth="2" /><text x="180" y="255" textAnchor="middle" fill="#FFFFFF">Monitor</text></g>
                <g><circle cx="80" cy="150" r="34" fill="#0B1A2E" stroke="#16B9A6" strokeWidth="2" /><text x="80" y="155" textAnchor="middle" fill="#FFFFFF">Report</text></g>
              </g>
              <circle cx="180" cy="150" r="6" fill="#16B9A6" style={{ animation: "nm-pulse 2.6s ease-in-out infinite" }} />
            </svg>
          </div>
        </figure>
      );
